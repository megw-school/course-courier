            ...
            <div className='content'>
                ...
                <p>
                    ...
                    <ul>
                        ...
                        <li>OAuth Authorization Flow: Recommended for multi-user environments to comply with service terms.</li>
                    </ul>
                </p>
                ...
                <p>
                    ...
                    <ul>
                        <li>Manual Token: Follow <a href="https://canvas.instructure.com/doc/api/file.oauth.html#manual-token-generation">Canvas' guide</a> for personal use cases.</li>
                        <li>OAuth Flow: Mandatory for applications serving multiple users to adhere to <a href="https://www.instructure.com/policies/api-policy">Canvas' terms of service</a>.</li>
                    </ul>
                </p>
                <p>Please consult the <a href="https://canvas.instructure.com/doc/api/file.oauth.html#accessing-canvas-api">Canvas API documentation</a> to select the appropriate method.</p>
                ...
                <p>Refer to the <a href="https://clickup.com/api/#authentication">ClickUp API authentication</a> section for detailed instructions on setting up your credentials correctly.</p>
